...
function deleteProvider(obj) {
    $.ajax({
        type: "GET",
        url: path + "/jsp/provider/delprovider.do",
...
$(function () {
    $(".viewProvider").on("click", function () {
        ...
        var obj = $(this);
        window.location.href = path + "/jsp/provider/view.do?id=" + obj.attr("proid");
    });

    $(".modifyProvider").on("click", function () {
        var obj = $(this);
        window.location.href = path + "/jsp/provider/modify.do?id=" + obj.attr("proid");
    });
