...
$(function(){
	$(".viewBill").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/jsp/bill/getBillById?id="+ obj.attr("billid");
	});
	
	$(".modifyBill").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/jsp/bill/modify.doo?id="+ obj.attr("billid");
	});
	$('#no').click(function () {
		cancleBtn();
	});
